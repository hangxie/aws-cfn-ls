...
type Cli struct {
	LogGroup  string `required:"" help:"CloudWatch log group name, eg /path/to/log/group"`
	LogStream string `required:"" help:"CloudWatch log stream, eg /path/to/log/stream"`
